      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <motion.h2 
            ...
            className="text-4xl md:text-6xl font-black bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-500"
          >
            Featured Projects
          </motion.h2>
        </div>
...
//                 <button
//                   onClick={() => setSelectedProject(null)}
//                   className="flex items-center gap-2 px-6 py-3 bg-red-500/10 border border-red-500/20 hover:bg-red-500 hover:text-white rounded-2xl transition-all duration-300 text-red-500 font-bold"
//                 >
//                   <FiX size={20} /> Close Preview
//                 </button>
//               </div>
//               {/* Content */}
//               <div className="p-8">
